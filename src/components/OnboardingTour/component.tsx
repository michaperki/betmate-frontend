...
const stepsForRoute = (route: string): Step[] => {
  if (route.startsWith('/chess/')) {
    return [
      ...
      { id: 'chess-move-predictions', title: 'Move Predictions', body: 'Preview potential next moves. Tap a move tile to place a bet on it.', anchor: 'single-move-prediction', advanceOnAnchorClick: true, globalStep: 5 },
  ...
  return [
    ...
    { id: 'dashboard-join-game', title: 'Join Featured Match', body: 'Scroll down and click the "Join Game" button on the featured match to start betting.', anchor: 'join-featured-button', advanceOnAnchorClick: true, globalStep: 2 },
