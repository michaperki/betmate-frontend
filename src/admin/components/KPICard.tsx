...
const KPICard: React.FC<KPICardProps> = ({
  ...
  // Determine trend status for styling
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        {badge && (
          <span style={{ fontSize: 12, color: iconColor, fontWeight: 600 }}>{badge}</span>
        )}
        ...
        <div className="mt-3 h-1.5 bg-slate-700 rounded-full overflow-hidden" style={{ marginTop: 12 }}>
          <div 
            ...
            style={{ 
              ...
              background: progressColor || "linear-gradient(to right, #10b981, #f59e0b, #ef4444)"
            }} 
          />
        </div>
      )}
